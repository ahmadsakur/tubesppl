...
<div id="content">
   <div class="container-fluid">
      ...
      <div class="row justify-content-center">
         <div class="col-md-8">
            <form enctype="multipart/form-data" action="/submit/{{$detail->id}}" method="POST">
               @csrf
               @method('PUT')
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="file" class="form-control-file" id="bukti1" name="bukti1" required>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="bukti" class="col-sm-2 col-form-label">Bukti 2</label>
                  <div class="col-sm-10">
                     <input type="file" class="form-control-file" id="bukti2" name="bukti2" required>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="bukti" class="col-sm-2 col-form-label">Bukti 3</label>
                  <div class="col-sm-10">
                     <input type="file" class="form-control-file" id="bukti3" name="bukti3" required>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="bukti" class="col-sm-2 col-form-label">Bukti 4</label>
                  <div class="col-sm-10">
                     <input type="file" class="form-control-file" id="bukti4" name="bukti4" required>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="bukti" class="col-sm-2 col-form-label">Bukti 5</label>
                  <div class="col-sm-10">
                     <input type="file" class="form-control-file" id="bukti5" name="bukti5" required>
                  </div>
               </div>
